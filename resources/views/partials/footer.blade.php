...
<footer id="contact" class="relative bg-gradient-to-br from-[#062419] via-[#031710] to-[#010906] text-slate-300 overflow-hidden border-t border-emerald-950/20">
    {{-- Decorative glow --}}
    <div aria-hidden="true" class="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-emerald-500/15 blur-3xl"></div>
    <div aria-hidden="true" class="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-emerald-600/15 blur-3xl"></div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
                ...
                <div class="mt-6 flex items-center gap-2.5">
                    @foreach ([
                        ...
                        <a href="{{ $s['href'] }}" target="_blank" rel="noopener" aria-label="{{ $s['label'] }}"
                           class="w-9 h-9 rounded-full bg-emerald-500/10 hover:bg-emerald-600 text-emerald-400 hover:text-white grid place-items-center transition">
            ...
            <div class="md:col-span-3">
                ...
                <ul class="space-y-2.5 text-sm">
                    <li><a href="{{ route('home') }}" class="text-slate-400 hover:text-emerald-400 transition">Beranda</a></li>
                    <li><a href="{{ route('menu') }}" class="text-slate-400 hover:text-emerald-400 transition">Menu Lengkap</a></li>
                    <li><a href="{{ route('cart.index') }}" class="text-slate-400 hover:text-emerald-400 transition">Keranjang</a></li>
                    <li><a href="{{ route('home') }}#tentang" class="text-slate-400 hover:text-emerald-400 transition">Tentang Kami</a></li>
                </ul>
            </div>
