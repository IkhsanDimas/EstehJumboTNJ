...
<footer id="contact" class="relative bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950 text-slate-300 overflow-hidden">
    {{-- Decorative glow --}}
    <div aria-hidden="true" class="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-emerald-500/10 blur-3xl"></div>
    <div aria-hidden="true" class="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-emerald-600/10 blur-3xl"></div>
                ...
                <div class="mt-6 flex items-center gap-2">
                    @foreach ([
                        ...
                        <a href="{{ $s['href'] }}" target="_blank" rel="noopener" aria-label="{{ $s['label'] }}"
                           class="w-9 h-9 rounded-full bg-white/5 hover:bg-emerald-600 hover:text-white text-slate-300 grid place-items-center transition">
