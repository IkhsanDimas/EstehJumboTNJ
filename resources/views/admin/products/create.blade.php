            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-6">
                ...
                <div class="md:col-span-8 space-y-5">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" required placeholder="Contoh: Es Teh Original Premium" class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 focus:bg-white transition">
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <select name="category_id" required class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs font-semibold text-slate-600 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 focus:bg-white transition">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" name="price" value="{{ old('price') }}" required min="0" placeholder="5000" class="w-full rounded-xl border border-slate-200 bg-slate-50 pl-10 pr-4 py-3 text-xs font-semibold text-slate-700 focus:outline-none focus:ring-2 focus:ring-blue-100 focus:border-blue-500 focus:bg-white transition">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2 cursor-pointer select-none">
                                <input type="radio" name="is_available" value="1" {{ old('is_available', '1') == '1' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
                                <span class="text-xs font-semibold text-slate-700">Tersedia (Bisa Dipesan)</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer select-none">
                                <input type="radio" name="is_available" value="0" {{ old('is_available') == '0' ? 'checked' : '' }} class="text-blue-600 focus:ring-blue-500">
