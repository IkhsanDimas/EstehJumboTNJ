...
<article class="group relative h-full bg-white rounded-2xl border border-slate-200/80 hover:border-slate-350/80 transition-all duration-300 flex flex-col overflow-hidden hover:shadow-[0_8px_35px_rgba(0,0,0,0.05)] hover:-translate-y-1"
    ...
    <button type="button"
            ...
            class="absolute top-3 right-3 z-20 w-8 h-8 rounded-full bg-white/90 backdrop-blur grid place-items-center shadow-xs transition-all duration-300 focus:outline-none">
    ...
    {{-- ─── Product Image ─── --}}
    <a href="{{ $detailUrl }}" class="block aspect-square relative p-4 flex items-center justify-center bg-white">
        <x-smart-image
    ...
    {{-- ─── Product Info ─── --}}
    <div class="flex flex-col flex-1 p-4 pt-3 bg-white">
        {{-- Category --}}
        ...
        <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between gap-3 bg-white">
