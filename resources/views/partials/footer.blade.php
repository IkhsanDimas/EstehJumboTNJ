<footer id="contact" class="relative bg-gradient-to-br from-[#041c0e] via-[#021209] to-[#010804] text-slate-300 overflow-hidden border-t border-green-950/20">
    {{-- Decorative glow --}}
    <div aria-hidden="true" class="absolute -top-32 -right-32 w-96 h-96 rounded-full bg-green-500/15 blur-3xl"></div>
    <div aria-hidden="true" class="absolute -bottom-32 -left-32 w-96 h-96 rounded-full bg-green-600/15 blur-3xl"></div>
    <div aria-hidden="true" class="absolute inset-0 opacity-[0.02]"
        ...
        <div class="grid grid-cols-1 md:grid-cols-12 gap-10">
            ...
            <div class="md:col-span-5">
                <a href="{{ route('home') }}" class="flex items-center gap-2">
                    <span class="w-9 h-9 rounded-xl bg-[#25D366] grid place-items-center text-white shadow-sm">
                ...
                <div class="mt-6 flex items-center gap-2.5">
                    @foreach ([
                        ...
                        <a href="{{ $s['href'] }}" target="_blank" rel="noopener" aria-label="{{ $s['label'] }}"
                           class="w-9 h-9 rounded-full bg-green-500/10 hover:bg-green-600 text-green-400 hover:text-white grid place-items-center transition">
            ...
            <div class="md:col-span-3">
                ...
                <ul class="space-y-2.5 text-sm">
                    <li><a href="{{ route('home') }}" class="text-slate-400 hover:text-green-400 transition">Beranda</a></li>
                    <li><a href="{{ route('menu') }}" class="text-slate-400 hover:text-green-400 transition">Menu Lengkap</a></li>
                    <li><a href="{{ route('cart.index') }}" class="text-slate-400 hover:text-green-400 transition">Keranjang</a></li>
                    <li><a href="{{ route('home') }}#tentang" class="text-slate-400 hover:text-green-400 transition">Tentang Kami</a></li>
                </ul>
            </div>
            ...
            <div class="md:col-span-4">
                ...
                <ul class="space-y-3 text-sm text-slate-400">
                    ...
                    <li class="flex items-center gap-3">
                        <svg class="w-4 h-4 text-green-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="4" width="20" height="16" rx="2"/><path d="m22 7-10 5L2 7"/></svg>
                    ...
                    <li class="flex items-center gap-3">
                        ...
                        @endphp
                        <svg class="w-4 h-4 text-green-500 flex-shrink-0" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="10"/><path d="M12 6v6l4 2"/></svg>
                        <span>Buka 09.00 – 22.00 WIB <span class="ml-2.5 px-2 py-0.5 rounded text-[10px] font-bold tracking-wider {{ $isOpen ? 'bg-green-500/15 text-green-400' : 'bg-rose-500/15 text-rose-400' }}">{{ $isOpen ? 'BUKA' : 'TUTUP' }}</span></span>
                    </li>
                </ul>
            </div>
        </div>
