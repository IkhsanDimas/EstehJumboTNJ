                ...
                <div class="md:col-span-8 space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div class="space-y-1.5">
                            ...
                            <select name="category_id" required class="w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-xs font-semibold text-slate-650 focus:outline-none focus:ring-2 focus:ring-emerald-100 focus:border-emerald-500 focus:bg-white transition">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="flex gap-4">
                            <label class="flex items-center gap-2 cursor-pointer select-none">
                                <input type="radio" name="is_available" value="1" {{ old('is_available', $product->is_available ? '1' : '0') == '1' ? 'checked' : '' }} class="text-emerald-600 focus:ring-emerald-500">
                                <span class="text-xs font-semibold text-slate-700">Tersedia (Bisa Dipesan)</span>
                            </label>
                            <label class="flex items-center gap-2 cursor-pointer select-none">
                                <input type="radio" name="is_available" value="0" {{ old('is_available', $product->is_available ? '1' : '0') == '0' ? 'checked' : '' }} class="text-emerald-600 focus:ring-emerald-500">
